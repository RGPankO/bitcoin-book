...
Накратко: правителството печата пари. Богатите купуват активи. Цените растат. Ти плащаш повече за същото. Кой е спечелил? Кой е загубил?

Ето ти трансфер на богатство. Без да ти пипнат паричника.

Нека го покажем с конкретен пример от България, нали.

2020-2022. Пандемия. ЕЦБ пуска безпрецедентни програми за изкупуване на активи — трилиони евро влизат в системата. Лихвените проценти падат до нула, после до отрицателни.

Кой получава евтиния кредит пръв? Банките. Инвеститорите. Хората с активи и история. Примерно, голям инвеститор с история и активи — получава ипотека за 10 апартамента при 1.5% лихва. Обикновеният работещ човек — трябва да се редиш за кредит при 3-4%.

Какво правят инвеститорите с евтините пари? Купуват имоти. В цяла Европа. Включително в Sofia.

Средната цена на жилище в Sofia 2019 г.: около 900-1000 евро на квадратен метър. 2023 г.: 1500-1800 евро. Нараснала е с 60-80% за четири години.

Средната заплата в България за същия период? Нараснала е с около 40%.

Значи докато Бай Иван с обикновена заплата се е борил да спести за апартамент — апартаментът е избягал от него. Той е работил по-усилено. Парите му обаче са поевтинели, а активите — не.

Кантийон ефект на практика: инвеститорите — получили евтиния кредит пръв — са купили апартаментите, преди цените да са скочили. После са ги наели на Бай Иван на наем, повишен с 50%. Той плаща. Те събират. А причината за тази разлика? Централна банка, печатаща пари.

Не е "пазарна сила". Не е "успех". Не е "умни инвестиции". Кантийон ефект. Трансфер на богатство от тези, получили парите накрая, към тези, получили ги пръв.

И ако питаш — "ами аз имам апартамент, значи съм в добрата група?" — може би. Засега. Стига следващия QE да не е насочен към клас активи, в който не си. Защото следващия път правилата могат да се сменят. Само декрет трябва.

Кантийон ефект. Работи в Европа. Работи в Bulgaria. Всяка минута. Без изключение.
...
В Bulgaria виждаме същото. Поколението на родителите ни е купило апартаменти при социализма за символични пари. Ние — купуваме при пазарни цени с ипотеки на 30 години. Те имат апартаменти. Ние — имаме дълг за апартаменти. Техните апартаменти поскъпват. Нашата заплата — не толкова.

Кантийон отново. Само с 60-годишно закъснение.
...
**Думи:** ~5700 | **Следваща глава:** Инфлацията — данъкът, който не гласуваш
