...
Брутният вътрешен продукт е сумата на всички транзакции в дадена икономика за определен период. Всичко, което се купува и продава — стоки, услуги, правителствени разходи — отива в числото.
...
Значи — ето фундаменталното разделение. Цената е числото на транзакцията. Стойността е реалният ефект върху живота.

Тези две неща не са едно и също. Никога не са били. И в здрава икономика те трябва да са свързани — но не са идентични.

Детски пример. Майка, която гледа детето си у дома — нула GDP. Майка, платила на детска градина за същото дете — добавена стойност към GDP. Децата получават едно и също — надзор, грижа, образование. Но системата вижда стойност само там, където се сменят пари.
...
Има дълбока мъдрост в идеята, която обществото на икономически растеж систематично отхвърля: *по-богат е не онзи, който харчи повече, а онзи, който се нуждае от по-малко.*
