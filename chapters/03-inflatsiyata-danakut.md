...
Има едно изследване от Shadow Government Statistics в Америка, което измерва инфлацията по методологията от 1980 г. Знаете ли колко е? Над 10% за последните 20 години — не 2-3%, официално отчетено.
...
## Кантийон ефектът — кой печели РЕАЛНО

Значи паричната маса расте. Парите се обезценяват. Но обезценяват ли се еднакво за всички?

Не. И тук е магическото.

Представи си: правителството печата 1 милиард нови лева. Тези пари влизат в системата — но не попадат едновременно при всички 7 милиона българи. Те попадат ПЪРВО при... банките. При правителствените изпълнители. При тези, близо до "печатницата".

Тези хора получават нови пари при СТАРИ цени. Те купуват активи — имоти, акции, злато — при стари цени. После новите пари се разпространяват из икономиката. Цените започват да растат.

Накрая — новите пари достигат до теб, наемния работник. Но до тогава цените вече са нараснали. Ти получаваш нови пари при НОВИ, по-високи цени.

Губиш.

Това е Кантийон ефектът — наречен по Ришар Кантийон, икономист от 18-ти век, който го е описал за пръв път. Той е живял в ерата на златните монети и е наблюдавал как кралят обезценява монетите (намалява количеството злато в тях). И е видял — кой е близо до краля, печели. Кой е далеч — губи.

Нищо не се е променило.

Днес "близо до краля" означава: банки, правителствени изпълнители, корпорации с достъп до евтин кредит, тези, купуващи имоти с ниски лихви.

"Далеч от краля" означава: ти. Аз. Всеки, получаващ заплата и спестяващ в банкова сметка.

Ето защо неравенството нараства. Не защото богатите са по-умни или по-трудолюбиви. А защото инфлационната система ги облагодетелства механично. Те получават новите пари ПЪРВИ. При стари цени. И купуват активи, чиито стойности после растат.

Не е конспирация. Просто механика.
...
Значи ще ти разкажа едно нещо лично.

Когато работех в Англия, преди да открия Bitcoin — спестявах. Добре се изкарваше. 3 000 паунда на месец е много добра заплата, дори за Англия. Слагах пари настрана.

Питах банката — IDS Bank — каква лихва дава при спестяване на 10 000 паунда.

Отговорили: 0.1%.

Значи — 10 000 паунда, за 1 година, ми дават 10 паунда. Десет паунда. Три кафета.

Аз им давам 10 000 паунда. Те ги използват — дават ги на заем, инвестират, печелят. И ми дават 10 паунда "благодарност".

Докато инфлацията яде реалната стойност на 10 000-те паунда.

Значи: лихвата ми е 0.1%. Инфлацията е 3-5%. Реалната ми загуба е 2.9-4.9% годишно. От 10 000 паунда — над 400 паунда загуба на покупателна сила само от ИНФЛАЦИЯТА.

Без да направя нищо лошо. Без да взема лошо решение. Без да хазартирам. Само защото съм спестявал.

Тогава разбрах. Системата не е счупена случайно. Системата е проектирана точно така — да те накара да НЕ спестяваш. Да инвестираш. Да рискуваш. Да харчиш.

А ако не го направиш — да губиш тихо, бавно, без да усетиш.

Затова съм в Bitcoin.

---

## Обобщение — инфлацията накратко

Преди да продължим, нека обобщим какво казахме:

**Инфлацията е два вида:** монетарна (повече пари в обращение) и ценова (цените растат). Двете не са едно и също.

**2% годишно се натрупва.** 30 години при 2% = 45% от покупателната сила изгубена. При по-висока инфлация — много повече.

**Технологичният прогрес ТРЯБВА да намалява цените.** Инфлацията изяжда тези ползи. Вместо ти да се радваш на по-евтин хляб заради по-ефективното земеделие — ползата е "конфискувана".

**Кантийон ефектът** гарантира, че новите пари облагодетелстват тези близо до печатницата — банките, правителствата, богатите — докато всички останали плащат чрез обезценяване.

**Инфлацията не е само в "третия свят".** България 1997. Западна Европа 2022. Турция, Аржентина, Ливан сега. Тя е характеристика на фиатната система — не изключение.

**"Имаме нужда от инфлация"** е аргумент на тези, нуждаещи се от инфлация — правителствата и банките с дългове. Не е аргумент за теб, спестителя.

**Инфлацията е данък.** Данък, за който никой не те е питал. Данък, гласуван от петима в зала за заседания. Данък, за чиито плащащи не е задължително да знаят, че го плащат.
